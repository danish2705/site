  ...
  const statusFiltered =
    statusFilter === "all"
      ...
      : recentFacilities.filter(
          (f) => statusGroupFor(f.status) === statusFilter,
        );
  ...
  const filtered = search.trim()
    ? statusFiltered.filter((f) =>
        [f.nctId, f.briefTitle, f.facility, f.city, f.state, f.country]
          .filter(Boolean)
          .some((v) =>
            (v as string).toLowerCase().includes(search.trim().toLowerCase()),
          ),
      )
    : statusFiltered;
  ...
  return (
    <div className="card">
      ...
      <div className="card-scroll-body">
        ...
        {loading && !data && (
          <TableSkeleton columns={5} rows={7} label="Loading ongoing trials…" />
        )}
            ...
            <div className="ct-toolbar">
              <div className="ct-stat-item ct-stat-item--inline">
                ...
                <div className="ct-stat-text">
                  ...
                  <div className="v">
                    {activeCompetingSites.toLocaleString()}
                  </div>
                </div>
              </div>
              ...
              <div className="ct-stat-item ct-stat-item--inline">
                ...
                <div className="ct-stat-text">
                  ...
                  <div className="v">
                    {recentFacilities.length.toLocaleString()}
                  </div>
                </div>
              </div>
              <div className="ct-divider" />
